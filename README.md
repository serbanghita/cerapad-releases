...
|--------------------------|---------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| CeraPad Free for macOS   | [Mac App Store](https://apps.apple.com/us/app/cerapad/id6805836944) | [`CeraPad-universal.dmg` (1.3.0)](https://github.com/serbanghita/cerapad-releases/releases/download/v1.3.0/CeraPad-universal.dmg) - universal (Apple Silicon and Intel), macOS 10.15+, signed and notarized with a Developer ID |
| CeraPad Free for Windows | [Microsoft Store](https://apps.microsoft.com/detail/9pc64pc4scgr)   | [`CeraPad-x64.exe` (1.3.0)](https://github.com/serbanghita/cerapad-releases/releases/download/v1.3.0/CeraPad-x64.exe) - Windows 10/11 (x64); unsigned, so SmartScreen warns on first run - verify with the SHA-256    |
| CeraPad Free for Linux   | -                                                                   | not yet                                                                                                                                                                                                             |
| CeraPad Pro for macOS    | -                                                                   | [`CeraPad-Pro-universal.dmg` (1.3.0)](https://github.com/serbanghita/cerapad-releases/releases/download/v1.3.0/CeraPad-Pro-universal.dmg) - universal (Apple Silicon and Intel), macOS 10.15+, signed and notarized with a Developer ID |
| CeraPad Pro for Windows  | -                                                                   | [`CeraPad-Pro-x64.exe` (1.3.0)](https://github.com/serbanghita/cerapad-releases/releases/download/v1.3.0/CeraPad-Pro-x64.exe) - Windows 10/11 (x64); unsigned, so SmartScreen warns on first run - verify with the SHA-256 |

**1.3.0 is a combined release** - both platforms were built the same day, so this tag carries both
