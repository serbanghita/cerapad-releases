...
| CeraPad Pro for macOS    | -                                                                   | [`CeraPad-Pro-universal.dmg` (1.3.3)](https://github.com/serbanghita/cerapad-releases/releases/download/v1.3.3/CeraPad-Pro-universal.dmg) - universal (Apple Silicon and Intel), macOS 10.15+, signed and notarized with a Developer ID |
| CeraPad Pro for Windows  | -                                                                   | [`CeraPad-Pro-x64.exe` (1.3.3)](https://github.com/serbanghita/cerapad-releases/releases/download/v1.3.3/CeraPad-Pro-x64.exe) - Windows 10/11 (x64); unsigned, so SmartScreen warns on first run - verify with the SHA-256 |
...
than waiting for each other, so the table can list different versions side by side: Pro
1.3.3 followed free 1.3.3 onto the same tag an hour later. A tag never mixes assets from
